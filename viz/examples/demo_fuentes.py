"""
Bake-off de tipografías de titular para REDES (formato vertical 1080x1350).
Renderiza el mismo gráfico (líneas + bandas) con cada fuente candidata.
"""
import sys
...
candidatas = {
    ...
    "font_spectral": "Spectral ExtraBold",
    "font_zillaslab": "Zilla Slab",
...
print("Bake-off listo:", ", ".join(candidatas))
